...
class AuthTests(unittest.TestCase):
    ...
    def test_login_success(self):
        ...
        # Mock the dashboard's database call so this test
        # focuses on authentication rather than the expense database.
        mocked_expenses = MagicMock(return_value=[])

        # Act
        with patch("app.database.login", mocked_login), \
             patch("app.database.get_employee_expenses", mocked_expenses):
        ...
        mocked_expenses.assert_called_once_with(1)
